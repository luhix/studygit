    ...
    <form action="" method="post" class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input  type="text" class="input-text" value="<?php echo $list['name']; ?>" placeholder="" id="name" name="name">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="email" class="input-text" placeholder="@" name="email" id="email" value="<?php echo $list['email']; ?>">
            </div>
        </div>
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
                ...
                <select class="select" name="role" size="1">
                    <?php if(is_array($res) || $res instanceof \think\Collection || $res instanceof \think\Paginator): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo $vo['role']; ?>"><?php echo switchAdmin($vo['role']); ?></option>
    ...
    $(function(){
        ...
        $("#submit").on("click", function(event){
            ...
            if($password == 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo url('user/updateUser'); ?>",
