<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\xampp\htdocs\106\public/../application/index\view\user\login.html";i:1507304725;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<form class="form form-horizontal" action="index.html" method="post">
			...
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					...
					<img src="<?php echo captcha_src(); ?>" id="varify_img">
					<a id="kanbuq" href="javascript:refeshVerify();">看不清，换一张</a>
				</div>
			</div>
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
...
<script>
	function refeshVerify() {
		var t = Math.random();
		$("#varify_img").attr("src","/captcha?id="+t);
	}
</script>
</body>
</html>